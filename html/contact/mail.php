...
$site_top = "http://dokodemo.japanese-goods-shop.com/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@sinsiarge.com,kudo.kozo.japan@gmail.com";//info@sinsiarge.com,
...
$refrom_name = "株式会社シンシアージュ";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【社食プラットフォームアプリ「どこでも社食」株式会社シンシアージュ：お問い合わせ】お問い合わせありがとうございます";
...
この度は株式会社シンシアージュにお問い合わせいただきまして、誠にありがとうございます。

いただきましたお問い合わせの内容を確認しまして、
担当者より1営業日以内にご連絡いたします。

今回お問い合わせいただきました内容は、下記の通りです。
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('電話番号','FAX番号','郵便番号');
...
<title>株式会社シンシアージュ | お問い合わせ | お問い合わせ内容のご確認</title>
</head>
...
<a class="navbar-brand" href="/"><span class="sr-only">株式会社シンシアージュ</span></a>
</div>
</div>
</nav>
</header>
...
<section class="application pa00" id="">
<div class="container">
<div class="col-md-10 col-md-offset-1 col-xs-12 pa00">
<h1 class="text-orange cir cir-orange mb50" style="float: none; font-size: 24px; width: 100%; text-align: center;">お問い合わせ内容のご確認<br></h1>
<?php if($empty_flag == 1){ ?>
...
<br>
<br>
<button type="button" class="btn btn-default btn-block btn-lg" onClick="history.back()">前画面に戻る</button>
</div>
<?php }else{ ?>
...
<button type="button" class="btn btn-default btn-lg" onClick="history.back()">前画面に戻る</button>
</div>
<div class="btn-group" role="group">
<button type="submit" class="btn btn-thin-primary btn-lg">送信する　<i class="fa fa-play-circle"></i></button>
</div>
</div>
</div>
</form>
...
<footer id="footer">
	<p class="text-center">Copyright &copy; Sinsiarge Inc.</p>
</footer>
</div>
</body>
</html>
...
<meta name="description" content="">
<meta name="author" content="">
<title>株式会社シンシアージュ | お問い合わせ | お問い合わせ完了</title>
</head>
...
<?php if($empty_flag == 1){ ?>
<h1 class="text-orange cir cir-orange mb50" style="float: none; font-size: 24px; width: 100%; text-align: center;">お問い合わせ内容のご確認<br></h1>
<strong>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</strong><br>
<div class="text-center" style="color:red"><?php echo $errm; ?></div>
<br>
<br>
<button type="button" class="btn btn-default btn-block btn-lg" onClick="history.back()">前画面に戻る</button>
</div>
...
<footer id="footer">
<p class="text-center">Copyright &copy; Sinsiarge Inc.,.Ltd.</p>
</footer>
</div>
</body>
</html>
...
<?php }else{ ?>
<h1 class="text-orange cir cir-orange mb50" style="float: none; font-size: 24px; width: 100%; text-align: center;">お問い合わせありがとうございます<br></h1>
<p>お問い合わせいただきました内容について、ご記入いただいた連絡先に回答をいたしますので、<br>
恐れ入りますが今しばらくお待ちください。<br><br>
迅速な対応を心がけておりますが、お問い合わせ内容によっては回答までお時間がかかる場合がございます。<br>
あらかじめご了承くださいますよう、よろしくお願いいたします。</p>
<a href="<?php echo $site_top ;?>" class="btn btn-default btn-block btn-lg">トップページへ戻る&raquo;</a>
</div>
</div>
</section>
...
<?php 
	...
	if($empty_flag == 1){ ?>
<div align="center"><strong>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</strong>
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	$adminBody="「".$subject."」から問い合わせがありました。\n\n";
	$adminBody .="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
